...
public class InterpretDrawingFile {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		double[] triangleOne =  {parameterOne, parameterThree, parameterFive};
		double[] triangleTwo =  {parameterTwo, parameterFour, parameterSix};
		...
		if(shapeType.equals("ellipse")){
			...
			StdDraw.rectangle(parameterOne, parameterTwo, parameterThree, parameterFour);
				...
				if(isFilled==true){
					StdDraw.setPenColor(redComponent, greenComponent, blueComponent);
					StdDraw.filledPolygon(triangleOne, triangleTwo);
			}
			else{
				StdDraw.setPenColor(redComponent, greenComponent, blueComponent);
				StdDraw.polygon(triangleOne, triangleTwo);
			}
		}
